-- ==========================================================
-- MIGRATION 002: Adicionar Módulo de Estampas (v2 - SEM DESCRICAO)
-- Data: 2025-11-03
-- CORREÇÃO: Removido campo "descricao" que não existe em processes
-- ==========================================================
...
-- ===========================
-- 11. SEEDS: Processos
-- ⚠️ CORRIGIDO: Removido campo "descricao"
-- ===========================
DO $$
DECLARE
  estampas_id INTEGER;
BEGIN
  ...
  -- ✅ INSERT corrigido: apenas campos que existem
  INSERT INTO processes (nome, modulo_id, tipo_processo, requer_maquina, ativo) VALUES
  ('Preparação de Bordado', estampas_id, 'preparacao', true, true),
  ('Bordado', estampas_id, 'maquina', true, true),
  ('Aplicação de DTF', estampas_id, 'maquina', true, true),
  ('Colagem de Patch', estampas_id, 'maquina', true, true)
