-- ==========================================================
-- MIGRATION 002: Adicionar Módulo de Estampas (VERSÃO FINAL)
-- Data: 2025-11-03
-- Descrição: Adiciona tabelas e campos para Bordado, DTF e Patch
-- Impacto: ZERO no módulo Acabamento
-- CORREÇÕES: UUID types + coluna "perfil" ao invés de "papel"
-- ==========================================================
...
-- ===========================
-- 7. MODIFICAR: users
-- ✅ CORRIGIDO: usa coluna "perfil"
-- ===========================
ALTER TABLE users ADD COLUMN IF NOT EXISTS modulos_permitidos TEXT[] DEFAULT ARRAY['acabamento'];

-- Atualizar usuários admin/gestor para ter acesso aos dois módulos
UPDATE users
...
BEGIN
  ...
  RAISE NOTICE '   - Coluna: perfil (ao invés de papel)';
  RAISE NOTICE '';
END $$;
